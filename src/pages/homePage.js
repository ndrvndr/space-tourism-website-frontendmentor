  ...
  return (
    <>
      ...
      <main className="bg-bg-mobile-home bg-cover h-full bg-no-repeat -z-10 px-6 flex flex-col items-center md:bg-tablet-home min-h-screen md:h-full lg:bg-desktop-home lg:flex-row lg:px-[165px] lg:justify-between">
        <div className="flex flex-col items-center justify-center mt-[112px] md:mt-[202px] lg:items-start">
        ...
        <button
          ...
          className="font-bellefair text-xl text-[#0B0D17] w-[150px] h-[150px] bg-white rounded-full border-none mt-[81px] mb-12 md:w-[242px] md:h-[242px] md:text-[32px] md:mt-[156px] lg:w-[274px] lg:h-[274px] lg:text-[32px] lg:tracking-[2px] lg:my-0 lg:absolute lg:bottom-0 lg:right-0 lg:mr-[165px] lg:mb-[131px]"
        >
          EXPLORE
        </button>
      </main>
